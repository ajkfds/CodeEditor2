...
{
    public class YamlParser : DocumentParser
    {
        [SetsRequiredMembers]
        public YamlParser(Data.YamlFile file, DocumentParser.ParseModeEnum parseMode, System.Threading.CancellationToken? token) : base(file, parseMode, token)
        {
            ...
            ParsedDocument = new YamlParsedDocument(file, file.RelativePath, file.CodeDocument.Version, parseMode);
        }
        ...
        public static Action<YamlParser>? ParseCustomYaml;
