...
{
    public class ParseRuleFileParser : DocumentParser
    {
        [SetsRequiredMembers]
        public ParseRuleFileParser(Data.ParseRuleFile file, DocumentParser.ParseModeEnum parseMode, System.Threading.CancellationToken? token) : base(file, parseMode, token)
        {
